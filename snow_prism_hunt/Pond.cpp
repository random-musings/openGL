...
Pond::Pond(
		...
		):Obstacle(newName,newPosition,Point(newPondRadius,newPondRadius,newPondRadius),Point(0,0,0),true,0),
...
void Pond::display(GLuint marbleTexture,GLuint waterTexture)
{
	...
	gluCylinder(pond,pondRadius,pondRadius+pondRadius*0.1,pondRadius, pondRadius*3,pondRadius*3);
