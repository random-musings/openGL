...
Point giftOrigin2(43,-44,-20); //under the snow drift
Point giftOrigin3(0,-44,-15); //in the air rotating
Point giftOrigin5(30,-44,40); //corner behind bezier drift
Point giftOrigin4(-43,-44,-43); //next to thesnowman
...
// ******* Snowballs ********
// **************************
const GLuint SNOWBALLID=22;
vector<Snowball*> projectiles;
int snowballDamage = 20;
float snowballGravity = 0.95;
float snowballAirFriction =0.99;
float snowballSpeed = 0.25;
...
Map currMap; //NPC Map
//Map currVehicleMap;
Point minCoords(-46,-46,-46);
Point maxCoords(46,46,46);
...
void  cleanup()
{
	...
	{
		vector<Snowball*>::iterator iter = projectiles.begin();
		delete *iter; //delete the snowball if it exists
		projectiles.erase(iter);
	}
