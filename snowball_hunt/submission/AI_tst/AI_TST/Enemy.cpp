...
void 	Enemy::UpdateCurrentState()
{
	...
	if(currentState==RELEASE_SNOWBALL)
	{
		currentState=IDLE; //wait for status to be changed
	}
...
float Enemy::getSnowRadius()
{
	return snowRadius;
}

void Enemy::setSnowRadius(float newSnowRadius)
{
	snowRadius = newSnowRadius;
}
