...
Point giftOrigin4(30,-44,40); //corner behind bezier drift
Point giftOrigin5(-43,-44,-43); //next to thesnowman
...
Map currMap; //NPC Map
//Map currVehicleMap;
Point minCoords(-47,-47,-47);
Point maxCoords(47,47,47);
